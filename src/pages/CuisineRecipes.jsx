...
import { getRecipesByArea } from "../services/recipeService";
...
function CuisineRecipes() {
  ...
  const loadRecipes = useCallback(async () => {
    ...
    try {
      ...
      const decodedCuisine =
        decodeURIComponent(cuisine);

      const data =
        await getRecipesByArea(decodedCuisine);
      ...
      setError(
        "Unable to load recipes for this cuisine. Please try again.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
          ...
          <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-stone-600 dark:text-stone-400 sm:text-lg">
                Explore delicious recipes inspired by{" "}
                {cuisineName.toLowerCase()} cuisine.
                Discover new flavors and dishes to cook
                at home.
              </p>
              ...
              <>
                ...
                <div className="mb-7 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="hidden text-sm font-bold text-orange-500 transition hover:text-orange-600 sm:block"
                  >
                    Browse More
                  </button>
                </div>
          ...
          {!loading &&
            ...
            recipes.length === 0 && (
              <EmptyState
                ...
                message={`We couldn't find any ${cuisineName.toLowerCase()} recipes.`}
        ...
        <section className="border-t border-orange-100 bg-white py-14 dark:border-stone-800 dark:bg-stone-900">
          ...
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            ...
            <p className="mt-3 text-stone-500 dark:text-stone-400">
              Discover recipes from other cuisines
              around the world.
            </p>

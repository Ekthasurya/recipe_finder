...
function IngredientRecipes() {
  ...
  const loadRecipes = useCallback(async () => {
    if (!ingredient) {
      setError("Ingredient is missing.");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      setError(
        "Unable to load recipes for this ingredient. Please try again.",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-stone-600 dark:text-stone-400 sm:text-lg">
                Discover delicious recipes made with{" "}
          ...
          {!loading &&
            ...
            recipes.length === 0 && (
              <EmptyState
                ...
                message={`We couldn't find any recipes using ${ingredientName.toLowerCase()}.`}
        ...
        <section className="border-t border-orange-100 bg-white py-14 dark:border-stone-800 dark:bg-stone-900">
          ...
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            ...
            <h2 className="mt-5 text-2xl font-extrabold text-stone-900 dark:text-white sm:text-3xl">
              Want to try another ingredient?
            </h2>

            <p className="mt-3 text-stone-500 dark:text-stone-400">
              Browse our complete ingredient collection
              and discover more recipes.
            </p>
